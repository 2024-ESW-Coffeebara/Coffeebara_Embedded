...
tx_rx_data = 0x00
#        ser.write(data_to_send.to_bytes(1, byteorder='big'))  # 1바이트 크기로 전송
...
def results_processing(largest_cup, largest_entrance, largest_holder):
    ...
    if entrance_x_diff >= 280:
        commend = commend | 0x03
    elif entrance_x_diff < 280 and entrance_x_diff > 260:
        commend = commend | 0x02
    else:
        commend = commend | 0x01
        ...
        if current_state == PY_RESET:
            ...
            for result in results:
                for box in result.boxes:
                    ...
                    if confidence < 0.5 or width > 350 or width < 200: 
                        continue
